...
$(combo_var_prefix)GLOBAL_CFLAGS := -fno-exceptions -Wno-multichar $(DEBUG_SYMBOL_FLAGS) $(DEBUG_FRAME_POINTER_FLAGS) 
$(combo_var_prefix)RELEASE_CFLAGS := -O2 -g0 -fno-strict-aliasing $(DEBUG_SYMBOL_FLAGS) $(DEBUG_FRAME_POINTER_FLAGS)
$(combo_var_prefix)GLOBAL_CPPFLAGS := $(DEBUG_SYMBOL_FLAGS) $(DEBUG_FRAME_POINTER_FLAGS)
$(combo_var_prefix)GLOBAL_LDFLAGS := $(DEBUG_SYMBOL_FLAGS) $(DEBUG_FRAME_POINTER_FLAGS)
